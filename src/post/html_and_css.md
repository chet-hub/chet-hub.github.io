<!-- # HTML & CSS -->
<!-- ![html_and_css.header](post/html_and_css.header.png) -->
...
![html_and_css.element_tag.png](post/html_and_css.element_tag.png)
(HTML, 2020)
...
![html_and_css.inline_block.png](post/html_and_css.inline_block.png)(Basic HTML: Block-level, Inline, and Organizational Elements)
